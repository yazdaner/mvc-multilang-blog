...
@section('title', 'create footerLinks')
        ...
        <div class="col-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ایجاد لینک فوتر</li>
                </ol>
            </nav>
            ...
            <div class="p-0">
                <div class="bg-white p-4 rounded">
                    ...
                    <form action="{{ route('admin.footerLinks.store') }}" method="POST">
                        @csrf
                        <div class="row">
